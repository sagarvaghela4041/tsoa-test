...
var ParameterGenerator = /** @class */ (function () {
    ...
    ParameterGenerator.prototype.getResParameters = function (parameter) {
        ...
        var statusArgumentTypes = statusArguments.map(function (a) { return _this.current.typeChecker.getTypeAtLocation(a); });
        ...
        return statusArgumentTypes.map(function (statusArgumentType) {
            ...
            return {
                ...
                name: status,
                parameterName: parameterName,
                examples: _this.getParameterExample(parameter, parameterName),
                required: true,
                type: type,
                schema: type,
                validators: {},
    ...
    ParameterGenerator.prototype.getUploadedFileParameter = function (parameter, isArray) {
        ...
        return {
            description: this.getParameterDescription(parameter),
            in: 'formData',
            name: (_a = decoratorUtils_1.getNodeFirstDecoratorValue(this.parameter, this.current.typeChecker, function (ident) {
                if (isArray) {
    ...
    ParameterGenerator.prototype.getFormFieldParameter = function (parameter) {
        ...
        return {
            description: this.getParameterDescription(parameter),
            in: 'formData',
            name: (_a = decoratorUtils_1.getNodeFirstDecoratorValue(this.parameter, this.current.typeChecker, function (ident) { return ident.text === 'FormField'; })) !== null && _a !== void 0 ? _a : parameterName,
            required: !parameter.questionToken && !parameter.initializer,
            type: type,
            parameterName: parameterName,
            validators: validatorUtils_1.getParameterValidators(this.parameter, parameterName),
    ...
    ParameterGenerator.prototype.getQueryParameters = function (parameter) {
        ...
        if (type.dataType === 'array') {
            ...
            return [
                __assign(__assign({}, commonProperties), { collectionFormat: 'multi', type: arrayType }),
            ];
        }
        if (!this.supportPathDataType(type)) {
        ...
        return [
            __assign(__assign({}, commonProperties), { type: type }),
        ];
    };
    ...
    ParameterGenerator.prototype.getParameterDeprecation = function (node) {
        return jsDocUtils_1.isExistJSDocTag(node, function (tag) { return tag.tagName.text === 'deprecated'; }) || decoratorUtils_1.isDecorator(node, function (identifier) { return identifier.text === 'Deprecated'; });
    };
    ...
    ParameterGenerator.prototype.supportParameterDecorator = function (decoratorName) {
        return ['header', 'query', 'path', 'body', 'bodyprop', 'request', 'res', 'inject', 'uploadedfile', 'uploadedfiles', 'formfield'].some(function (d) { return d === decoratorName.toLocaleLowerCase(); });
    };
